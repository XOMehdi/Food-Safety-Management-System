...
<html>
  ...
  <body>
    <div class="flex">
      <div
        class="w-1/4 h-screen bg-gray-900 text-white flex flex-col justify-center"
      >
        <ul class="ml-3 mt-10">
          <li class="mb-4">
            <a href="../home.php" class="hover:text-blue-200 font-medium"
              >Home</a
            >
          </li>
          <li class="mb-4">
          ...
          <li class="mb-4">
            <a
              href="adding_ingredient.html"
              class="hover:text-blue-200 font-medium"
              >Ingredient Addition</a
            >
          </li>
          <li class="mb-4">
            <a
              href="../status_checking/status_checking.php"
              class="hover:text-blue-200 font-medium"
              >Meal Status Checking</a
            >
          </li>
          <li class="mt-10">
            <a
              class="block bg-white text-blue-500 py-2 px-2 rounded-full mr-6 text-center"
              href="../logout.php"
              >Log Out</a
            >
          </li>
      ...
      <div
        class="w-3/4 h-screen bg-white flex flex-col justify-center items-center overflow-y-auto"
      >
        ...
        <nav class="bg-gray-100 py-4 w-full">
          <div class="container mx-auto flex justify-center">
            <a
              id="nav-ingredient"
              class="px-6 py-2 rounded-lg bg-white mr-2 hover:text-gray-500 focus:outline-none"
              href="#section-ingredient"
            >
              Ingredient Details
            </a>
            <a
              id="nav-supplier"
              class="px-6 py-2 rounded-lg text-gray-700 hover:text-gray-500 focus:outline-none"
              href="#section-supplier"
            >
              Supplier Details
            </a>
            <a
                  ...
                  <div class="flex justify-center">
                    <div class="w-1/4">
                      ...
                      <div class="mb-4">
                        ...
                        <input
                          class="appearance-none border rounded-lg py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline w-full"
                          placeholder="Enter Cost of the Ingredient"
                    ...
                    <div class="w-1/4">
                      <div class="mb-4">
                        ...
                        <input
                          type="text"
                          class="appearance-none border rounded-lg py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline w-full"
                          placeholder="Enter the Name of the Allergy Type"
                          name="allergy_type"
                        />
                      </div>
                      <div class="mb-4">
