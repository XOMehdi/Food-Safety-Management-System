...
CREATE TABLE chef (chef_id varchar(10) NOT NULL, chef_fname varchar(50), chef_lname varchar(50), chef_age int(3), chef_gender char(1), chef_password varchar(50) NOT NULL, PRIMARY KEY (chef_id));
